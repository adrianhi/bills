      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSave} className="space-y-4 py-2">
          ...
          <div className="rounded-xl border bg-muted/40 p-3.5 text-xs space-y-1">
            ...
            <div className="flex justify-between">
              <span className="text-muted-foreground">Original (BHD):</span>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold">Nombre del Comercio</label>
            <Input
              value={merchant}
              onChange={(e) => setMerchant(e.target.value)}
              placeholder="Ej: Supermercados Bravo"
              required
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Ej: Compra de víveres para el fin de semana"
            />
          </div>
