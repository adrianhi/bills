...
export const statsSummarySchema = z.object({
  ...
  comparison: z.object({
    ...
    expenseChangeAmount: z.number(),
    currentPeriod: financialPeriodSchema,
    previousPeriod: financialPeriodSchema,
    categoryDeltas: z.array(financialDeltaSchema),
    merchantDeltas: z.array(financialDeltaSchema),
  }).optional(),
