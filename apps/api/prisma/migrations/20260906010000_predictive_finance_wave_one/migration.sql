CREATE TYPE "IncomeFrequency" AS ENUM ('WEEKLY', 'BIWEEKLY_15_30', 'MONTHLY', 'CUSTOM');
...
CREATE TABLE "income_streams" (
  ...
  "frequency" "IncomeFrequency" NOT NULL DEFAULT 'BIWEEKLY_15_30',
...
CREATE INDEX "income_streams_workspace_id_idx" ON "income_streams"("workspace_id");
...
ALTER TABLE "income_streams" ADD CONSTRAINT "income_streams_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "income_streams" ADD CONSTRAINT "income_streams_amount_check" CHECK ("amount" > 0);
ALTER TABLE "income_streams" ADD CONSTRAINT "income_streams_currency_check" CHECK ("currency" IN ('DOP', 'USD'));
  ...
  FOREACH app_role IN ARRAY ARRAY['anon', 'authenticated'] LOOP
    IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = app_role) THEN
      FOREACH table_name IN ARRAY ARRAY[
        'income_streams', 'recurring_bills', 'recurring_occurrences', 'recurring_alerts',
